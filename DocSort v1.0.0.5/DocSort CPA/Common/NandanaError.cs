	...
	public class NandanaError
	{
		...
		#region Privates
			...
			public static void PostError(NandanaResult Result)
			{
				...
				XmlElement oError = CreateRootElement(oRoot,Result.errorCode.ToString(),Result.errorDescr.ToString() + ":" + GetErrorMessage(Result.errorCode));
				if(Result.errorException!=null)
				{
					oError.AppendChild(CreateExceptionElement(oRoot,Result.errorException));
				}
				if(Result.session!=null)
					oError.AppendChild(CreateSessionElement(oRoot,Result.session));
