...
namespace RatingControls
{
	public class StarRatingControl : System.Windows.Forms.Control
	{
		...
		protected void DrawStar ( Graphics g, Rectangle rect, int starAreaIndex )
		{
            ...
            {
                fillBrush = new LinearGradientBrush(rect, HoverColor, Color.LightGray, LinearGradientMode.ForwardDiagonal);
            }
            else if ((!m_hovering) && m_selectedStar > starAreaIndex)
            {
                fillBrush = new LinearGradientBrush(rect, System.Drawing.ColorTranslator.FromHtml("#19abaa"), System.Drawing.ColorTranslator.FromHtml("#19abaa"), LinearGradientMode.ForwardDiagonal);
            }
            else
            {
