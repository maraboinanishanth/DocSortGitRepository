                    ...
                    for (int i = 0; i < document.Pages.Count; i++)
                    {
                        ...
                        using (Bitmap bitmap = new Bitmap((int)(scale * page.Width), (int)(scale * page.Height)))
                        {
                            ...
                            try
                            {
                                ...
                                //OrganizeWithFileName value should always be N, we introduced this for our first project Dr Behara and that too for the first time custom organizing we ned as Y.
                                String organizeWithFileName = ConfigurationManager.AppSettings["OrganizeWithFileName"].ToString();
                                if (organizeWithFileName == "Y")//this needs to go to the Config. ANd shoud only work for first time for beharas. and shud never work for other clients.
                                {
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                using (Bitmap bitmap = new Bitmap((int)(scale * page.Width), (int)(scale * page.Height)))
                {
                    ...
                    try
                    {
                        ...
                        //OrganizeWithFileName value should always be N, we introducsed this for Dr Behara and that too for the first time custom organizing we ned as Y.
                        String organizeWithFileName = ConfigurationManager.AppSettings["OrganizeWithFileName"].ToString();
                        if (organizeWithFileName == "Y")//this needs to go to the Config. ANd shoud only work for first time for beharas. and shud never work for other clients.
                        {
